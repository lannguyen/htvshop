...
$(document).ready(function(){
   ...
   /* $( "#modify_order" ).dialog({
	...
	$("#modify_order").dialog("open"); */
	
	$("#new").click(function(){
		var url = "index.php?mod=order&act=add";
...
<div id="top-panel">
	<div id="panel">
		<ul>
			<li><a href="#" class="order_add" id="new">Tạo mới</a></li>
		...
		<div id="box">
			...
			<h3>DANH SÁCH ĐƠN ĐẶT HÀNG</h3>
				...
				<table id="list">
					...
					<tbody>
						...
						<tr>
							...
							<td align="center">
							<a href="#" class="add_link "><img src="../admin/img/icons/order_add.png" title="Thêm mới" width="16" height="16" /> </a> 
							<a href="#" class="modify_link"><img src="../admin/img/icons/order_edit.png" height="16" title="Chỉnh sửa" /> </a> 
							<a href="#" class="delete_link"> <img src="../admin/img/icons/order_del.png" title="Xóa bỏ" width="16" height="16" /></a>
							</td>
				...
				<div style="margin: 15px 0 0 2px; padding-bottom: 10px;">
					Trang &nbsp;
					<?php echo pagenav($base_url, $s,"start",$tongso, $soorders);?>
				</div>				
		</div>
		<br/>
...
switch($act){
	case "del":
		include("modules/order/orders_del.php");
		break;
	case "modify":
		include("modules/order/orders_modify.php");	
		break;		
	case "add":
		include("modules/order/orders_add.php");
		break;
}
?>
</div>
